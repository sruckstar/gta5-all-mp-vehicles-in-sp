...
public class Planes : Script
{
    ...
    public Planes()
    {
        ...
        coords[0] = new Vector3(-961.005f, -2963.593f, 13.945f);
        all_coords = 0;

        angle[0] = 147.589f;

        models[0] = VehicleHash.Microlight;
        models[1] = VehicleHash.Nimbus;
        models[2] = VehicleHash.Luxor2;
        models[3] = VehicleHash.Velum2;
