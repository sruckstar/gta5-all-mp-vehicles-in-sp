...
public class Helicopters : Script
{
    ...
    public Helicopters()
    {
        ...
        coords[0] = new Vector3(-979.378f, -2996.868f, 13.945f);
        all_coords = 0;

        angle[0] = 331.180f;

        models[0] = VehicleHash.Conada;
        models[1] = VehicleHash.Havok;
        models[2] = VehicleHash.Volatus;
        models[3] = VehicleHash.Supervolito;
        models[3] = VehicleHash.Supervolito2;
        models[3] = VehicleHash.Swift2;
