...
public class WeaponsBoat : Script
{
    ...
    public WeaponsBoat()
    {
        ...
        coords[0] = new Vector3(-3092.066f, 3465.729f, -0.474f);
        all_coords = 0;

        angle[0] = 47.552f;

        models[0] = VehicleHash.Dinghy5;
        models[1] = VehicleHash.PatrolBoat;
        models[2] = VehicleHash.Tug;
