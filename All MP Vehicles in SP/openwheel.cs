...
public class openwheel : Script
{
    ...
    public openwheel()
    {
        ...
        models[0] = VehicleHash.OpenWheel2;
        models[1] = VehicleHash.OpenWheel1;
        models[2] = VehicleHash.Formula;
        models[3] = VehicleHash.Formula2;
        models[4] = VehicleHash.Raptor;
